        ...
        <section class="section">
          <nav aria-label="breadcrumb">
              <ol class="breadcrumb bg-primary text-white-all">
                  ...
                  <li class="breadcrumb-item active" aria-current="page"><i class="fas fa-user-friends"></i> About Game Result </li>
              </ol>
          </nav>
  ...
  $(function() {
      $.fn.tableload = function() {
          $('#recentWorksTable').dataTable({
              ...
              "ajax": {
                url: "{{ route('show_all_GameResult_data') }}",
                  "type": "POST",
                  "data": function(d) {
                      d._token = "{{ csrf_token() }}";
                  },
